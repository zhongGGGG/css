...
@Controller
public class customerbasicsController {

    @Resource
    private BasDictService basDictService;

    @RequestMapping(value = "/customerbasics/list")
...
//        List<BasDict> types = basDictService.findBasDictsByAndDictType("客户等级");
        ...
        Page<BasDict> basDicts=basDictService.findAll(dictItem,"地区",pageable);

        model.addAttribute("basDictsPager",basDicts);
        model.addAttribute("dictItem",dictItem);
        return "/customerbasics/list";
    }

    @RequestMapping(value = "/customerbasics/basiadds")
    public String adds(){
        return "/customerbasics/basiadds";
    }

    @RequestMapping(value = "/customerbasics/add_dict")
    public String add(Model model, BasDict basDict, HttpSession session){
        ...
        List<BasDict> types = basDictService.findBasDictsByAndDictType("地区");
    ...
    @RequestMapping(value = "/customerbasics/update")
    public String update(Long dictId,Model model){
        ...
        return "/customerbasics/update";
    }

    @RequestMapping(value = "/customerbasics/del")
    @ResponseBody
    @Transactional
